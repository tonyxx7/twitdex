package actionscript.data
{
	public class TwitterSearch
	{
		...
		private var _sinceDate:Date;
		private var _untilDate:Date;
		...
		public function set sinceDate(date:Date):void
		{
			_sinceDate = sinceDate;
		}
		
		public function get sinceDate():Date
		{
			return _sinceDate;
		}
		
		public function get sinceDateString():String
		{
			return format(_sinceDate);
		}
		
		public function set untilDate(date:Date):void
		{
		...
		public function get untilDateString():String
		{
			return format(_untilDate);
		}
		...
		private static function format(d:Date):String
		{
		...
		public function get queryString():String
		{
			...
			if (_sinceDate)
			{
				params.push('since%3A' + this.sinceDateString);
			}
			if (_untilDate)
			{
				params.push('until=' + this.untilDateString);
			}
			qs += params.join('+');
			if (_lang)
			{
